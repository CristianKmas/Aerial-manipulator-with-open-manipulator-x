...
void OpenManipulatorTeleop::setGoal(char ch)
{
  ...
  else if (ch == '2')
  {
    ...
    joint_name.push_back("joint4"); joint_angle.push_back(0.2);
  ...
  else if (ch == '1')
  {
    ...
    joint_name.push_back("joint4"); joint_angle.push_back(0.7);
    setJointSpacePath(joint_name, joint_angle, path_time);
  }
  else if (ch == '3')
  {
    printf("input : 3 \trst pose\n");
  ...
  else if (ch == '4')
  {
    ...
    joint_name.push_back("joint3"); joint_angle.push_back(0.45);
    joint_name.push_back("joint4"); joint_angle.push_back(-1.5);
    setJointSpacePath(joint_name, joint_angle, path_time);
  }
  else if (ch == '5')
  {
    printf("input : 5 \trdm pose\n");
